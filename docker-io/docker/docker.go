...
func main() {
	...
	var (
		...
		flRoot               = flag.String([]string{"g", "-graph"}, "/srv/docker", "Path to use as the root of the docker runtime")
		...
		flExecDriver         = flag.String([]string{"e", "-exec-driver"}, "lxc", "Force the docker runtime to use a specific exec driver")
